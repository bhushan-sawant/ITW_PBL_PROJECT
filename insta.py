...
def post():
    ...
    messagebox.showinfo('Downloading...', 'Requested post is downloaded!')
...
my_label_1=Label(text="What do you want to download",bg="yellow",fg="purple",font="italian",borderwidth=10,relief=SUNKEN)
